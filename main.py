...
world = {
    {
  "uuid": "081481B3-9DD0-4D24-8011-57B538675855",
  "name": "Zork",
  "creator": "Twine",
  "creatorVersion": "2.3.14",
  "schemaName": "Harlowe 3 to JSON",
  "schemaVersion": "0.0.6",
  "createdAtMs": 1630559329803,
  "passages": [
    {
      "name": "West of House",
      "tags": "",
    ...
    },
    {
      ...
      "tags": "",
      "id": "5",
      "text": "You are behind the white house. A path leads into the forest to the east. In one corner of the house there is a small window which is slight ajar.\n\n[[NORTH->North of House]]\n[[SOUTH->South of House]]\n[[EAST->Sunlit Forest]]\n[[WEST->Kitchen]]\n[[ENTER->Kitchen]]",
      "links": [
        {
          "linkText": "NORTH",
          "passageName": "North of House",
      ...
      "hooks": [],
      "cleanText": "You are behind the white house. A path leads into the forest to the east. In one corner of the house there is a small window which is slight ajar."
    },
    {
      "name": "Sunlit Forest",
      "tags": "",
      "id": "6",
      "text": "This is a dimly lit forest, with large trees all around. One particularly large tree with some low brances stands here.\n\n[[NORTH->Forest]]\n[[SOUTH->Forest]]\n[[EAST->Forest]]\n[[WEST->East of House]]\n[[UP->Tree]]",
      "links": [
        {
          "linkText": "NORTH",
          "passageName": "Forest",
      ...
      "hooks": [],
      "cleanText": "This is a dimly lit forest, with large trees all around. One particularly large tree with some low brances stands here."
    },
    {
      "name": "Kitchen",
      "tags": "",
    ...
    },
    {
      ...
      "tags": "",
      "id": "8",
      "text": "You are about 10 feet above the ground nestled among some large branches. The nearest brand above you is above your reach. Beside you on the branch is a small bird's nest.\n\n[[DOWN->Sunlit Forest]]",
      "links": [
        {
          "linkText": "DOWN",
          "passageName": "Sunlit Forest",
      ...
      "hooks": [],
      "cleanText": "You are about 10 feet above the ground nestled among some large branches. The nearest brand above you is above your reach. Beside you on the branch is a small bird's nest."
    }
  ]
}
}
